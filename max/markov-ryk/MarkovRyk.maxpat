...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 350.0, 266.0, 128.0, 236.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 516.0, 82.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 516.0, 271.0, 408.0, 177.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 516.0, 122.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "initialize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 571.0, 122.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "compile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 516.0, 209.0, 61.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-3" : [ "live.menu[33]", "live.menu", 0 ],
			...
			"obj-6::obj-13::obj-9" : [ "live.menu[39]", "live.menu[2]", 0 ],
			"obj-4::obj-69" : [ "I[1]", "I", 0 ],
			...
			"obj-4::obj-19" : [ "live.dial[1]", "Velocity", 0 ],
			...
			"obj-4::obj-7" : [ "live.menu[34]", "live.menu", 0 ],
			...
			"obj-4::obj-17" : [ "Length", "Length", 0 ],
			"obj-4::obj-70" : [ "I[2]", "I", 0 ],
			"obj-6::obj-7::obj-17::obj-2" : [ "live.numbox[39]", "live.numbox", 0 ],
			"obj-6::obj-13::obj-8" : [ "live.menu[40]", "live.menu[1]", 0 ],
			"obj-6::obj-11::obj-13::obj-2" : [ "live.numbox[34]", "live.numbox", 0 ],
			"obj-6::obj-14::obj-8" : [ "live.menu[36]", "live.menu[1]", 0 ],
			...
			"obj-4::obj-30" : [ "live.menu[35]", "live.menu[32]", 0 ],
			...
			"obj-6::obj-13::obj-12" : [ "live.menu[38]", "live.menu[3]", 0 ],
			...
			"obj-4::obj-38" : [ "live.text", "live.text", 0 ],
			...
			"obj-6::obj-13::obj-3" : [ "live.menu[41]", "live.menu", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "main.js",
